'''
MITx - 6.00.1x- Problem set2 - Problem 2 - Paying Debt Off in a Year
...
In this problem, we will not be dealing with a minimum monthly payment rate. The following variables contain values as described below:
...
Hint - Assume that the interest is compounded monthly according to the balance at the end of the month (after the payment for that month is made).
...
fixedMonthlyPay = balance//10
fixedMonthlyPay = fixedMonthlyPay - (fixedMonthlyPay % 10)
balance = balance - fixedMonthlyPay
print (balance)

while balance > 0:
    fixedMonthlyPay = fixedMonthlyPay + 10
    for i in range (12):
        balance = balance - fixedMonthlyPay
        print ("I am here")

print (fixedMonthlyPay)
